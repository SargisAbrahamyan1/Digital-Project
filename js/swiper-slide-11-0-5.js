...
var Swiper = function() {
    ...
    const ue = [function(e) {
        ...
        function m() {
            ...
            "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass} home__slide__digit"></span> <div class="slash"></div> <span class="${e.totalClass} home__slide__digit"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), t.pagination.bullets = [], a.forEach((s => {
